...
import { QrCode, ClipboardList, ClipboardCheck, Fuel } from 'lucide-react'
      ...
      <div className="px-4 py-4 border-t border-gray-100">
        <div className="flex items-center gap-3 px-2 py-2">
          <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center">
            <span className="text-xs font-bold text-blue-700">RO</span>
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-gray-900 truncate">Roberto Oliveira</p>
            <p className="text-xs text-gray-400">Shell — Centro · Frentista</p>
          </div>
        </div>
      </div>
    </aside>
